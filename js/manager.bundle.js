...
console.log("manager.bundle.js has been injected and is running");

// Ensure the DOM is fully loaded before creating the ExeManager instance
document.addEventListener('DOMContentLoaded', (event) => {
    console.log("In manager bundle");
    window.autofill_manager = new ExeManager(document.URL);
    window.autofill_manager.create_popup();
});

window.onload = function () {
    console.log("window.onload has been triggered");
