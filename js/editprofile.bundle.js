...
function get_form_data() {
    ...
    data["ethnicities"] = editprofileform["inputethnicity"].value;
    data["gender"] = editprofileform["inputgender"].value;
    data["hear"] = editprofileform["inputhear"].value;
    data["lgbtq"] = editprofileform["inputlgbtq"].value;
    data["transgender"] = editprofileform["inputlgbtq"].value;
    data["sexual"] = editprofileform["inputsexual"].value;
...
function checkAndLoadData() {
    ...
    chrome.storage.local.get("userdata", function (result) {
        ...
        if (userData) {
            console.log("in edit profile bundle");
            var editprofileform = document.forms["editprofileform"];
            ...
            editprofileform["inputhear"].value = userData["hear"];
            editprofileform["inputlgbtq"].value = userData["lgbtq"];
            editprofileform["inputsexual"].value = userData["sexual"];
